...
//        assertEquals(ClusterHealthStatus.GREEN, healthResponse.getStatus());
    ...
    @Test
    public void indexTrack() throws Exception {
        JobExecution execution = testUtils.launchJob();

        // Batch Status
        assertEquals(ExitStatus.COMPLETED, execution.getExitStatus());
        StepExecution indexTrack = getStepExecution(execution, "indexTrack");
        assertEquals(1, indexTrack.getWriteCount());
        assertEquals(1,  indexTrack.getCommitCount());
