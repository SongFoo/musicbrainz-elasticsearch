...
public class ArtistU2Operations {
	...
	private static final int TRACK_ID_RED_HILL_MINING_TOWN = 15093481;
	private static final int RECORDING_ID_RED_HILL_MINING_TOWN = 172339;
	private static final int MEDIUM_ID_RED_HILL_MINING_TOWN = 1347781;
	private static final int RELEASE_ID_RED_HILL_MINING_TOWN = 1307203;
    ...
    //1307203	1b406ff6-3df4-4ce4-b3c1-dacfbe0cd8ef	The Joshua Tree	197	20435	1	1	120	28	5014474300066		0	-1	2015-07-09T23:01:41.485341-07:00[America/Los_Angeles]
	private static Operation insertRelease() {
		return insertInto("release")
				.columns("id", "gid", "name", "artist_credit", "release_group")
				.values(RELEASE_ID_RED_HILL_MINING_TOWN, "1b406ff6-3df4-4ce4-b3c1-dacfbe0cd8ef", "The Joshua Tree", ARTIST_ID_U2, RELEASE_GROUP_JOSHUA_TREE_ID)
				.build();
	}

	//1347781	1307203	1	1		0	2013-07-07T14:37:49.910752-07:00[America/Los_Angeles]	11
	private static Operation insertMedium() {
		return insertInto("medium")
				.columns("id", "release", "position", "track_count", "format")
				.values(MEDIUM_ID_RED_HILL_MINING_TOWN, RELEASE_ID_RED_HILL_MINING_TOWN, 1, 11, 1)
				.build();
	}

	private static Operation insertRecordingMeta() {
		return insertInto("recording_meta")
				.columns("id", "rating", "rating_count")
				.values(RECORDING_ID_RED_HILL_MINING_TOWN, 47, 3)
				.build();
	}

	private static Operation insertRecording() {
		return insertInto("recording")
				.columns("id", "gid", "name", "artist_credit", "length")
				.values(RECORDING_ID_RED_HILL_MINING_TOWN, "3f7ee760-5ba7-462d-b523-f0e0026df4a6", "Red Hill Mining Town", ARTIST_ID_U2, 293933)
				.build();
	}

    //Red Hill Mining Town	6	15093481	ecb4621d-2968-4519-82ad-83d3a88305c6	1347781	172339	1		The Joshua Tree	20435	6f3e9fa6-be7a-3de8-a2b2-2072ece8a54d	1	The Joshua Tree	U2	1987	87	14
	private static Operation insertTrack() {
		return insertInto("track")
				.columns("id", "gid", "name", "position", "number", "medium", "recording", "artist_credit")
				.values(TRACK_ID_RED_HILL_MINING_TOWN, "ecb4621d-2968-4519-82ad-83d3a88305c6", "Red Hill Mining Town", 6, 6, 1347781, 172339, ARTIST_ID_U2)
				.build();
	}
