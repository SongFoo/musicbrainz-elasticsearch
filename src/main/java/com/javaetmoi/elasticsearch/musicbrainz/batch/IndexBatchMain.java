...
public class IndexBatchMain {
    ...
    public static void main(String... args) {
        ...
        try {
            if (args.length > 0 && args[0].equals("track")) {
                LOG.info("I AM ON TRACK BRO!!!");
                context = new ClassPathXmlApplicationContext(new String[]{
                        ...
                        "com/javaetmoi/elasticsearch/musicbrainz/batch/applicationContext-track-batch.xml"});

                JobLauncher jobLauncher = context.getBean(JobLauncher.class);
                Job trackJob = context.getBean("trackJob", Job.class);
                jobLauncher.run(trackJob, new JobParameters());
            } else {
                context = new ClassPathXmlApplicationContext(new String[]{
                        "com/javaetmoi/elasticsearch/musicbrainz/batch/applicationContext-datasource.xml",
                        "com/javaetmoi/elasticsearch/musicbrainz/batch/applicationContext-elasticsearch.xml",
