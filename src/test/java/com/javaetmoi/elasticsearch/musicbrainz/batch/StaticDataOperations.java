...
public final class StaticDataOperations {
    ...
    //1	CD		0	1982	true		9712d52a-4509-3d4b-a1a2-67c88c643e31
	public static final Insert MEDIUM_FORMAT_ROWS =
			insertInto("medium_format")
					.columns("id", "name", "child_order", "year")
					.values(1, "CD", 0, 1982)
					.build();
